...
<body>
	...
	<div class="container-fluid single-product">
		<div class="col">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Book name: ${product.name}</h5>
					<p class="card-text">Book description: ${product.description}</p>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" productId="${product.id}"
						class="btn btn-primary buy-product">Buy</button>
				</div>
			</div>
		</div>
	</div>
<a href="cabinet.jsp" >Go to main page</a>
